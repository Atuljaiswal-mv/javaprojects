...
if(basicSalary.signum()==-1)throw new DAOException("Basic salary in negative");
...
DesignationDAOInterface designationDAO=new DesignationDAO();
if(!designationDAO.codeExists(designationCode))throw new DAOException("designstion code not exists :"+designationCode);
...
randomAccessFile.close();
throw new DAOException("Invalid emplpoyee Id.:"+"("+employeeId+")");
}catch(IOException ioException)
{
throw new DAOException(ioException.getMessage());
}
